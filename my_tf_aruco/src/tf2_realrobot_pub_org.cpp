...
private:
  ...
  void aruco_geometry_callback(
    ...
    tf2::Transform transform_arucoFrame_camera(
        myTransform * q_arucoFrame_camera, p_arucoFrame_camera);
    ...
    // msg_arucoFrame_camera.transform.translation.x =
    // p_arucoFrame_camera.getX(); msg_arucoFrame_camera.transform.translation.y
    // = p_arucoFrame_camera.getY();
    // msg_arucoFrame_camera.transform.translation.z =
    // p_arucoFrame_camera.getZ(); msg_arucoFrame_camera.transform.rotation.x =
    // q_arucoFrame_camera.getX(); msg_arucoFrame_camera.transform.rotation.y =
    // q_arucoFrame_camera.getY(); msg_arucoFrame_camera.transform.rotation.z =
    // q_arucoFrame_camera.getZ(); msg_arucoFrame_camera.transform.rotation.w =
    // q_arucoFrame_camera.getW();
    // tf_broadcaster_->sendTransform(msg_arucoFrame_camera);

    std::string fromFrameRel0 = "aruco_link"; // from parent to child
    std::string toFrameRel0 = "D415_color_optical_frame_my_answer"; // child
    geometry_msgs::msg::TransformStamped msg_camera_aruco;
    rclcpp::Time now0 = this->get_clock()->now();
    msg_camera_aruco.header.stamp = now0;
    msg_camera_aruco.header.frame_id = fromFrameRel0;
    msg_camera_aruco.child_frame_id = toFrameRel0;
    ...
    std::string fromFrameRel2 =
        "D415_color_optical_frame_my_answer"; // from parent to child
    ...
    msg_aruco_camera.header.frame_id = fromFrameRel2;
    msg_aruco_camera.child_frame_id = toFrameRel2;
    msg_aruco_camera.transform.translation.x = p_arucoFrame_camera.getX();
    msg_aruco_camera.transform.translation.y = p_arucoFrame_camera.getY();
    msg_aruco_camera.transform.translation.z = p_arucoFrame_camera.getZ();
    msg_aruco_camera.transform.rotation.x = q_arucoFrame_camera.getX();
    msg_aruco_camera.transform.rotation.y = q_arucoFrame_camera.getY();
    msg_aruco_camera.transform.rotation.z = q_arucoFrame_camera.getZ();
    msg_aruco_camera.transform.rotation.w = q_arucoFrame_camera.getW();
