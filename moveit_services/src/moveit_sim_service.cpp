...
public:
  MoveitSimServerNode(rclcpp::NodeOptions &node_options)
      : Node("moveit_sim_service_node", node_options) {

    node_ = std::make_shared<rclcpp::Node>("moveit_sim_service");
    executor_ = std::make_shared<rclcpp::executors::SingleThreadedExecutor>();
    srv_ = create_service<SetBool>(
        "moveit_sim_service",
        std::bind(&MoveitSimServerNode::moveit_sim_callback, this, _1, _2));
...
private:
  ...
  void moveit_sim_callback(const std::shared_ptr<SetBool::Request> request,
