...
static const rclcpp::Logger LOGGER =
    rclcpp::get_logger("move_realrobot_service");
...
private:
  ...
  void
  moveit_realrobot_callback(const std::shared_ptr<SetBool::Request> request,
                            const std::shared_ptr<SetBool::Response> response) {

    if (request->data == DATA_GO_SHOW) {
      RCLCPP_INFO(LOGGER, "moveit_realrobot_callback");
      // visual_tools->prompt("Press 'next' in the RvizVisualToolsGui window to
      // continue the demo");

      RCLCPP_INFO(LOGGER, "moveit_realrobot_callback2");

      const moveit::core::JointModelGroup *joint_model_group =
          move_group->getCurrentState()->getJointModelGroup(PLANNING_GROUP);
      RCLCPP_INFO(LOGGER, "moveit_realrobot_callback3");
      ...
      joint_group_positions[0] = 167*3.14159/180;   // Shoulder Pan
      joint_group_positions[1] = -62*3.14159/180; // Shoulder Lift
      joint_group_positions[2] = 113*3.14159/180;  // Elbow
      joint_group_positions[3] = -123*3.14159/180; // Wrist 1
      joint_group_positions[4] = -33*3.14159/180; // Wrist 2
      joint_group_positions[5] = -116*3.14159/180; // Wrist 3
      move_group->setJointValueTarget(joint_group_positions);
